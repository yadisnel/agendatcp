...
namespace Agenda.ModuloAyudaXps.Herramientas
{
    ...
    /// </summary>
    public partial class GestorXps
    {
        #region Constructor
        public GestorXps(string applicationDir)
        {
        ...
        public void IterateXpsPackageParts(XpsDocument xpsDocument, TreeView treeView, string fileName)
        {
