...
{
    public partial class DialogoAdicionarModificarMunicipios
    {
        public EntidadMunicipio Municipio { get; set; }

        public DialogoAdicionarModificarMunicipios()
        {
            InitializeComponent();
            ...
            //DataContext = Municipio;
        }
        //public void ConfigurarDialogo(bool esOperacionModificar)
        //{
        //    if (esOperacionModificar)
        //    {
        //        ControlBarraTitulo.Titulo = "Modificar municipio";
        //        this.Title = ControlBarraTitulo.Titulo;
        //    }
        //    else
        //    {
        //        ControlBarraTitulo.Titulo = "Adicionar nuevo municipio";
        //        this.Title = ControlBarraTitulo.Titulo;
        //    }
        //}
